import { ApiService, ApiFactory, ConfigurationService, Zynjectable } from '../core';
...
export class DevicesService {
    ...
    constructor(private apiFactory: ApiFactory, private configuration: ConfigurationService) {
